 ...
 */
   ...
   *  ****************************************************************************
   */
  m_packetInterval (0.00396500), //Richard: originally (0.1), now set to 0.0001 does seem to affect throughput; this means packet is sent every <interval> second over simulation period
...
*/
  ...
  */
  ...
  AnimationInterface  anim ("./visualisation_files/mesh_c_m_hwmp.xml"); //trace file
...
/*
  ...
  */
  ...
  Simulator::Run ();
  //the "." before the file path moves one step out of directory of execution
  flowmon->SerializeToXmlFile (("./folder_for_measurements/mesh_c_m_hwmp_scenario4_airtime-aug_time=10.xml"), false, false); //my version ~Richard
