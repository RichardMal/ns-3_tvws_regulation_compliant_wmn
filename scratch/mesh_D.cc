...
private:
  ...
  void ChannelAssignment(); //Richard: this is my addition [23 February 2019]
 ...
 */
 //Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Phy/$ns3::YansWifiPhy/ChannelNumber", UintegerValue(40));
  ...
  Config::Set ("/NodeList/2/DeviceList/*/$ns3::WifiNetDevice/Phy/$ns3::YansWifiPhy/ChannelNumber", UintegerValue(36));
...
/*
 ...
 Config::Connect ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Phy", MakeCallback (&PhyTrace));
 ...
 * i) change channel setting at run-time
 * ii)
 */
void MeshTest::ChannelAssignment()
{
	std::cout<<"In ChannelAssignment(): "<<std::endl;
	/*
