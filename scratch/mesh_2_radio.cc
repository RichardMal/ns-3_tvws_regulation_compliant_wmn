 ...
 */
   ...
   */
   ...
   //Uncomment when testing airtime and a_airtime
...
*/
  ...
  */
  ...
  AnimationInterface  anim ("./visualisation_files/TEST.xml"); //trace file
...
*/
  ...
  Simulator::Run ();
  //the "." before the file path moves one step out of directory of execution
  flowmon->SerializeToXmlFile (("./folder_for_measurements/TEST.xml"), false, false); //my version ~Richard
