...
using namespace ns3;
  ...
  */
  ...
  std::string out_file_for_convergence_times = "./Richard_output_logs/non-best-case-convergence_grid_topology_3x3_tvws_regulation_compliant_mesh.csv";
 ...
 */
  m_xSize (3),
  m_ySize (3), //total number of nodes = m_xSize * m_ySize
  ...
  m_randomStart (0.1),
  m_totalTime (24), //Richard: simulation time in seconds, I think?
  /*
   * ******************************************************************************
...
/*START try of setDown, setUp */
     ...
     uint32_t ipv4ifIndex = 1;
      ...
      Simulator::Schedule (Seconds (1),&Ipv4::SetUp,ipv4, ipv4ifIndex);
