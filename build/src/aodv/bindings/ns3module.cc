...
static PyMethodDef PyNs3AodvNeighbors_methods[] = {
    {(char *) "AddArpCache", (PyCFunction) _wrap_PyNs3AodvNeighbors_AddArpCache, METH_KEYWORDS|METH_VARARGS, "AddArpCache(arg0)\n\ntype: arg0: ns3::Ptr< ns3::ArpCache >" },
    ...
    {(char *) "DelArpCache", (PyCFunction) _wrap_PyNs3AodvNeighbors_DelArpCache, METH_KEYWORDS|METH_VARARGS, "DelArpCache(arg0)\n\ntype: arg0: ns3::Ptr< ns3::ArpCache >" },
...
static PyMethodDef PyNs3AodvRoutingProtocol_methods[] = {
    ...
    {(char *) "SetDesinationOnlyFlag", (PyCFunction) _wrap_PyNs3AodvRoutingProtocol_SetDesinationOnlyFlag, METH_KEYWORDS|METH_VARARGS, "SetDesinationOnlyFlag(f)\n\ntype: f: bool" },
    ...
    {(char *) "GetDesinationOnlyFlag", (PyCFunction) _wrap_PyNs3AodvRoutingProtocol_GetDesinationOnlyFlag, METH_NOARGS, "GetDesinationOnlyFlag()\n\n" },
...
PyTypeObject PyNs3AodvRoutingTableEntry_Type = {
    ...
    (PyBufferProcs*)NULL,  /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                      /* tp_flags */
    "RoutingTableEntry(dev, dst, vSeqNo, m_seqNo, iface, hops, nextHop, lifetime)\nRoutingTableEntry(arg0)",                        /* Documentation string */
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
...
static PyMethodDef PyNs3AodvRreqHeader_methods[] = {
    ...
    {(char *) "GetGratiousRrep", (PyCFunction) _wrap_PyNs3AodvRreqHeader_GetGratiousRrep, METH_NOARGS, "GetGratiousRrep()\n\n" },
    ...
    {(char *) "SetGratiousRrep", (PyCFunction) _wrap_PyNs3AodvRreqHeader_SetGratiousRrep, METH_KEYWORDS|METH_VARARGS, "SetGratiousRrep(f)\n\ntype: f: bool" },
...
static PyMethodDef aodv_internal_functions[] = {
    {NULL, NULL, 0, NULL}
};
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef aodv_internal_moduledef = {
    PyModuleDef_HEAD_INIT,
    "aodv.internal",
    NULL,
    -1,
    aodv_internal_functions,
};
#endif

static PyObject *
initaodv_internal(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&aodv_internal_moduledef);
    #else
    m = Py_InitModule3((char *) "aodv.internal", aodv_internal_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
PyTypeObject Pystd__vector__lt___ns3__Ptr__lt___ns3__QueueDisc___gt_____gt___Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "aodv.Std__vector__lt___ns3__Ptr__lt___ns3__QueueDisc___gt_____gt__",            /* tp_name */
...
PyTypeObject Pystd__vector__lt___ns3__Ptr__lt___ns3__QueueDisc___gt_____gt__Iter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "aodv.Std__vector__lt___ns3__Ptr__lt___ns3__QueueDisc___gt_____gt__Iter",            /* tp_name */
