 ...
 */
class OlsrWithDsaHelper : public Ipv4RoutingHelper
{
public:
  /**
   * Create an OlsrWithDsaHelper that makes life easier for people who want to install
   * OLSR routing to nodes.
   */
  OlsrWithDsaHelper ();

  /**
   * \brief Construct an OlsrWithDsaHelper from another previously initialized instance
   * (Copy Constructor).
   */
  OlsrWithDsaHelper (const OlsrWithDsaHelper &);

  /**
   * \returns pointer to clone of this OlsrWithDsaHelper
   *
...
private:
   ...
   */
  OlsrWithDsaHelper &operator = (const OlsrWithDsaHelper &);
