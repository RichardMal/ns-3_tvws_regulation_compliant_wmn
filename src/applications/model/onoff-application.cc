...
//my additions -Richard
/*
Ptr<Socket>
OnOffApplication::GetDataRate (void) const */ //version 1
DataRate OnOffApplication::GetDataRate() //version 2
{
  NS_LOG_FUNCTION (this);
 // DataRate rate = m_cbrRate;
  //std::cout<<" ..in GetDataRate():"<<rate <<std::endl;
  return m_cbrRate;
}
}
