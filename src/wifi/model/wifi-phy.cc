...
WifiPhy::NotifyMonitorSniffRx (Ptr<const Packet> packet, uint16_t channelFreqMhz, uint16_t channelNumber, WifiTxVector txVector, MpduInfo aMpdu, SignalNoiseDbm signalNoise)
{
	...
	// std::cout << "From NotifyMonitorSniffRx() in wifi-phy.cc line# ~2193: channel# = " << channelNumber << "  channel FreqMhz = "<< channelFreqMhz << std::endl;
...
{
	//std::cout << "From NotifyMonitorSniffTx() in wifi-phy.cc line# ~2201: channel# = " << channelNumber << "  channel FreqMhz = "<< channelFreqMhz <<std::endl;
