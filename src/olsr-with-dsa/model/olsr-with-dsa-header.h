...
public:
  ...
  void SetOriginatorDataRate(uint16_t originatorDataRate)
  {
	  m_originatorDataRate = originatorDataRate;
  }

  uint16_t GetOriginatorDataRate() const
  {
	  return m_originatorDataRate;
  }
  //END Richard's lines
...
private:
  ...
  uint16_t m_originatorDataRate; //!<The originator data rate.
