 ...
 */
#include "olsr-with-dsa-helper.h"
#include "ns3/olsr-with-dsa-routing-protocol.h"
...
OlsrWithDsaHelper::OlsrWithDsaHelper ()
{
  m_agentFactory.SetTypeId ("ns3::olsr::RoutingProtocol");
}

OlsrWithDsaHelper::OlsrWithDsaHelper (const OlsrWithDsaHelper &o)
...
OlsrWithDsaHelper*
OlsrWithDsaHelper::Copy (void) const
{
  return new OlsrWithDsaHelper (*this);
}

void
OlsrWithDsaHelper::ExcludeInterface (Ptr<Node> node, uint32_t interface)
{
...
OlsrWithDsaHelper::Create (Ptr<Node> node) const
{
...
void
OlsrWithDsaHelper::Set (std::string name, const AttributeValue &value)
{
  m_agentFactory.Set (name, value);
}

int64_t
OlsrWithDsaHelper::AssignStreams (NodeContainer c, int64_t stream)
{
