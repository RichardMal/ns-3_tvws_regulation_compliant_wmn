 ...
 * List of  changes:
 * 	replaced all "Airtime" occurences with "hopCount"
 */

#ifndef HOP_COUNT_METRIC_H
#define HOP_COUNT_METRIC_H
 ...
 */
class HopCountLinkMetricCalculator : public Object
{
public:
  HopCountLinkMetricCalculator ();
